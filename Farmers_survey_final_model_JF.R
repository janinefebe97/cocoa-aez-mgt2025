...
# Author: Janine
# Date: 23 Oct
#this dataset looks at the yield data from the interviews to quantifies the relationship between shade cover and cocoa yield across Ghana’s agro-ecological zones. 
